...
public class registerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        message = null;
        messageDetail = null;
        String email, pass, passAgain,mno;
        ...
        mno=request.getParameter("mobileReg").trim();
                ...
                if (isEmailValid) {
                    if (pass.length() > 7) {
                        if (pass.equals(passAgain)) {
                            ...
                            String sql = "INSERT INTO  `marutidb`.`user` "
                                    + "(`user_id` ,`email` ,`pass` ,`registeredOn`,`mobileno`) "
                            ...
                            if (i == 1) {
                                ...
                                String msg="Welcome to MarutiShop App \nusername: "+email+"\npasssword:"+pass;
                                Mailer m=new Mailer();
                                m.send(email,"MarutiShopApp Registration",msg);
                                SMSAPIJAVA.send(mno);
                                user User = new user();
