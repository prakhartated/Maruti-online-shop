            ...
            while (rs.next()) {
                ...
                if (email.equals(db_email)) {
                    ...
                    if (pass.equals(db_pass)) {
                        ...
                        //out.print(userSession.getAttribute("admin"));
                        //response.sendRedirect("/MarutiShopApp/admin_settings.jsp");
                        response.sendRedirect(request.getContextPath()+"/admin_settings.jsp");  
